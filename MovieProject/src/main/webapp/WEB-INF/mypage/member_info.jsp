		...
		<div class="container">
			<div class="row ipad-width2">
				<div class="col-md-3 col-sm-12 col-xs-12">
						<div class="info">
							<h2> <strong><%=member1.getM_name() %> 님</strong> </h2>
							<h3> <strong><%=member1.getM_email() %></strong></h3>
						</div>
				...
				<div class="col-md-9 col-sm-12 col-xs-12">
					...
					<form action="./member_update.do" method="post" name="infoform" >
						<table class="tbinfo_hjs">
								...
								<tbody>
									<tr>
										<td> 이메일 </td>
										<td> <div class="td-content"><%=member1.getM_email() %></div> </td>
									</tr>
									<tr>
										<td> 비밀번호 변경 </td>
										<td>
											...
											<div class="inpbx1">
												...
												<input id="user_password" placeholder="현재 비밀번호" value="<%=member1.getM_password() %>" type="password" class="ng-untouched ng-pristine ng-invalid">
											</div>
											<div class="inpbx1">
												<label for="new_password">신규 비밀번호</label>
												<input id="new_password" name="m_password" placeholder="신규 비밀번호" type="password" class="ng-untouched ng-pristine ng-invalid">
											</div>
											<div class="inpbx1">
									...
									<tr>
										<td> 이름 </td>
										<td> <div class="td-content"><%=member1.getM_name() %></div> </td>
									</tr>
									<tr>
										<td> 닉네임 </td>
										<td> 
											<div class="td-content">
												<input type="text" name="m_nickname" value="<%=member1.getM_nickname() %>"/>
